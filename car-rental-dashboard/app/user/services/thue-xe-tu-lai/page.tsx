...
export default function ThueXeTuLaiPage() {
    const features = ["Đa dạng loại xe", "Thủ tục nhanh gọn", "Bảo hiểm toàn diện", "Hỗ trợ 24/7"]
                    ...
                    <CardHeader>
                        <div className="flex items-center gap-4">
                            <div className="bg-sky-100 w-14 h-14 rounded-full flex items-center justify-center">
                                <Car className="h-7 w-7 text-sky-600" />
                            </div>
                            <div>
                                <CardTitle className="text-2xl">Thuê Xe Tự Lái</CardTitle>
                                <p className="text-gray-600 mt-1">
                                    Thuê xe tự lái đa phân khúc, thủ tục đơn giản, xe bảo dưỡng định kỳ.
                                </p>
                            </div>
                        </div>
                    </CardHeader>
